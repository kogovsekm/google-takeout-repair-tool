...
- macOS Apple Silicon: use `Google Takeout Repair Tool-1.0.5-arm64.dmg`
- macOS Intel: use `Google Takeout Repair Tool-1.0.5.dmg`
- Windows 64-bit: use `Google Takeout Repair Tool Setup 1.0.5.exe`
- Linux 64-bit: use `Google Takeout Repair Tool-1.0.5.AppImage`
...
- Linux: the AppImage may not start until it has executable permission. If needed, run `chmod +x "Google Takeout Repair Tool-1.0.5.AppImage"` and launch it again.
...
npm run release:all -- 1.0.5  # bump version, build macOS+Windows+Linux installers, regenerate SHA256SUMS
